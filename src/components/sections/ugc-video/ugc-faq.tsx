...
const faqData: FAQItem[] = [
  {
    question: "What Is an AI UGC Video Maker?",
    answer: "An AI UGC Video Maker is a tool that uses artificial intelligence to automatically create user-generated content style videos, scripts, and creative concepts. Instead of spending weeks sourcing creators, you can generate high-performing, authentic-looking UGC videos in minutes — ready to launch and optimized for results.",
  },
  {
    question: "How Does Adona's UGC Video Generator Work?",
    answer: "Start by entering your website link, and Adona's AI will analyze your brand voice, visual style, and target audience. It then generates unique, high-performing UGC video ideas that you can easily edit, customize, and launch in minutes.",
  },
  {
    question: "What Types of UGC Videos Can I Create with Adona?",
    answer: "Adona can generate all major types of UGC videos, including product reviews, testimonials, and unboxing content. This gives you the flexibility to create high-performing campaigns for any objective — from awareness to conversions.",
  },
  {
    question: "Do I need to hire creators to generate UGC videos?",
    answer: "No, Adona's AI UGC video generator is designed to make your life easier. All you need is a website URL, and our AI will take it from there — no creators needed.",
  },
  {
    question: "How Do I Create UGC Videos with Adona?",
    answer: "Getting started is simple. Paste your website URL, choose a video concept, and customize the content to match your goals. No complex setup, no technical skills — just fast, high-quality UGC videos ready to launch.",
  },
  {
    question: "Can I Use a UGC Video Maker for Free? How Much Does Adona Cost?",
  ...
  {
    question: "What Makes Adona Different from other UGC video creation tools?",
  ...
  {
    question: "Does Adona Improve UGC Video Performance?",
    answer: "Yes. Adona uses insights from millions of high-performing marketing assets to understand what drives engagement and conversions. This allows it to generate UGC videos designed to attract attention, increase trust, and deliver better results.",
  },
];
