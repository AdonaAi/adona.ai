...
const faqData: FAQItem[] = [
  {
    question: "What Is an AI Instagram Ad Maker?",
    answer: "An AI Instagram Ad Maker is a tool that uses artificial intelligence to automatically create ad copy, visuals, and creative concepts. Instead of spending hours brainstorming, writing, and designing, you can generate high-performing, scroll-stopping Instagram ads in minutes — ready to launch and optimized for results.",
  },
  {
    question: "How Does Adona's Instagram Ad Generator Work?",
  ...
  {
    question: "What Types of Instagram Ads Can I Create with Adona?",
    answer: "Adona can generate all major types of Instagram ads, including static image ads, carousel ads, and video ads. This gives you the flexibility to create high-performing campaigns for any objective — from awareness to conversions.",
  },
  {
    question: "Do I need design or copywriting skills to generate ads?",
    answer: "No, Adona's AI Instagram ad generator is designed to make your life easier. All you need is a website URL, and our AI will take it from there.",
  },
  {
    question: "How Do I Create Instagram Ads with Adona?",
  ...
  },
  {
    ...
    answer: "Yes. Adona uses insights from millions of high-performing marketing assets to understand what drives engagement and conversions. This allows it to generate Instagram ads designed to attract attention, increase clicks, and deliver better results.",
  },
];

export default function IGAdsFAQ() {
