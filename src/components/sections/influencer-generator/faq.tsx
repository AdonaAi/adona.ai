...
const faqData: FAQItem[] = [
  {
    ...
    answer: "An AI Influencer Generator is a tool that uses artificial intelligence to automatically create virtual influencer personas and content. Instead of spending time and money on influencer partnerships, you can generate high-performing, consistent AI influencer content in minutes — ready to launch and optimized for results.",
  },
  {
    question: "How Does Adona's AI Influencer Generator Work?",
    answer: "Start by defining your ideal influencer persona, and Adona's AI will analyze your brand voice, visual style, and target audience. It then generates unique, high-performing AI influencer content that you can easily edit, customize, and launch in minutes.",
  },
  {
    question: "What Types of AI Influencer Content Can I Create with Adona?",
    answer: "Adona can generate all major types of AI influencer content, including product showcases, testimonials, and promotional videos. This gives you the flexibility to create high-performing campaigns for any objective — from awareness to conversions.",
  },
  {
    question: "Do I need design or video editing skills to generate AI influencer content?",
    answer: "No, Adona's AI influencer generator is designed to make your life easier. All you need is a website URL, and our AI will take it from there.",
  },
  {
    question: "How Do I Create AI Influencer Content with Adona?",
    answer: "Getting started is simple. Define your influencer persona, choose a content concept, and customize the content to match your goals. No complex setup, no technical skills — just fast, high-quality AI influencer content ready to launch.",
  },
  {
    question: "Can I Use an AI Influencer Generator for Free? How Much Does Adona Cost?",
  ...
  {
    question: "What Makes Adona Different from other AI influencer tools?",
  ...
  {
    question: "Does Adona Improve AI Influencer Performance?",
    answer: "Yes. Adona uses insights from millions of high-performing marketing assets to understand what drives engagement and conversions. This allows it to generate AI influencer content designed to attract attention, increase followers, and deliver better results.",
  },
];
