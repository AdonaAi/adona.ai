...
const faqData: FAQItem[] = [
  {
    ...
    answer: "An AI Ad Generator is a tool that uses artificial intelligence to automatically create ad copy, visuals, and creative concepts. Instead of spending hours brainstorming, writing, and designing, you can generate high-performing, scroll-stopping ads in minutes — ready to launch and optimized for results.",
  },
  {
    question: "How Does Adona's Ad Generator Work?",
  ...
  {
    question: "What Types of Ads Can I Create with Adona?",
    answer: "Adona can generate all major types of ads, including static image ads, carousel ads, and video ads. This gives you the flexibility to create high-performing campaigns for any objective — from awareness to conversions.",
  },
  {
    question: "Do I need design or copywriting skills to generate ads?",
    answer: "No, Adona's AI ad generator is designed to make your life easier. All you need is a website URL, and our AI will take it from there.",
  },
  {
    question: "How Do I Create Ads with Adona?",
  ...
  },
  {
    ...
    answer: "Yes. Adona uses insights from millions of high-performing marketing assets to understand what drives engagement and conversions. This allows it to generate ads designed to attract attention, increase clicks, and deliver better results.",
  },
];

export default function AdGeneratorFAQ() {
