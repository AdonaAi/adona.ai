...
const HowItWorks = () => {
  const steps = [
    ...
    },
    {
      ...
      description: 'Our AI Facebook ad creator delivers unlimited, unique ad ideas daily.',
      videoUrl: 'https://framerusercontent.com/assets/s9If74dnp3LTbVF2LYWmlmvaN8.mp4',
    },
    {
      number: '03',
      title: 'Edit & launch',
      description: 'Customize the ad to your liking, and hit publish when you’re ready.',
      ...
      <div className="container max-w-[1200px] mx-auto px-6">
        <div className="text-center mb-20 md:mb-32">
          <h2 className="text-[32px] md:text-[48px] font-bold leading-[1.2] text-[#000000] tracking-tight">
            How adona.ai Facebook Ad<br className="hidden md:block" /> Generator Works
          </h2>
        </div>
