...
const faqData: FAQItem[] = [
  {
    question: "What Is an AI TikTok Video Maker?",
    answer: "An AI TikTok Video Maker is a tool that uses artificial intelligence to automatically create video content, scripts, and creative concepts. Instead of spending hours filming and editing, you can generate high-performing, scroll-stopping TikTok videos in minutes — ready to launch and optimized for results.",
  },
  {
    question: "How Does Adona's TikTok Video Generator Work?",
    answer: "Start by entering your website link, and Adona's AI will analyze your brand voice, visual style, and target audience. It then generates unique, high-performing video ideas that you can easily edit, customize, and launch in minutes.",
  },
  {
    question: "What Types of TikTok Videos Can I Create with Adona?",
    answer: "Adona can generate all major types of TikTok videos, including product showcases, testimonials, and trending content. This gives you the flexibility to create high-performing campaigns for any objective — from awareness to conversions.",
  },
  {
    question: "Do I need design or video editing skills to generate videos?",
    answer: "No, Adona's AI TikTok video generator is designed to make your life easier. All you need is a website URL, and our AI will take it from there.",
  },
  {
    question: "How Do I Create TikTok Videos with Adona?",
    answer: "Getting started is simple. Paste your website URL, choose a video concept, and customize the content to match your goals. No complex setup, no technical skills — just fast, high-quality videos ready to launch.",
  },
  {
    question: "Can I Use a Video Maker for Free? How Much Does Adona Cost?",
  ...
  {
    question: "What Makes Adona Different from other video creation tools?",
  ...
  {
    question: "Does Adona Improve Video Performance?",
    answer: "Yes. Adona uses insights from millions of high-performing marketing assets to understand what drives engagement and conversions. This allows it to generate TikTok videos designed to attract attention, increase views, and deliver better results.",
  },
];

export default function TikTokFAQ() {
